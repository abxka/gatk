...
public class AssemblyRegionArgumentCollection implements Serializable {
    ...
    @Advanced
    @Argument(fullName= DONT_TRIM_LONG_NAME, doc="If specified, we will not trim down the active region from the full region (active + extension) to just the active interval for genotyping", optional = true)
